...
- (void)setShowPhotoIndex:(BOOL)showPhotoIndex{
    _showPhotoIndex = showPhotoIndex;
    _textView.hidden = !showPhotoIndex;
    _indexLabel.hidden = !showPhotoIndex;
...
- (void)setShowSaveButton:(BOOL)showSaveButton{
    ...
    _saveImageBtn.hidden = !_showSaveButton;
    
    self.userInteractionEnabled = NO;
    
    if(_indexLabel.hidden){
        [self removeFromSuperview];
    }
}
