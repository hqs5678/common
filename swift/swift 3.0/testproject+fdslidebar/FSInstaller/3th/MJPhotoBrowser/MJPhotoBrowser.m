...
- (void)createToolbar
{
    ...
    _photoToolbar = [[MJPhotoToolbar alloc] initWithFrame:CGRectMake(0, barY, self.view.frame.size.width, barHeight)];
    _photoToolbar.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
    _photoToolbar.photos = _photos;
    [self.view addSubview:_photoToolbar];
...
- (void)showPhotoViewAtIndex:(NSUInteger)index
{
    ...
    photoView.contentMode = photo.srcImageView.contentMode;
