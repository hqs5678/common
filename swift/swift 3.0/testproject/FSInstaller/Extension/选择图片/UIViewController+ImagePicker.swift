...
extension UIViewController{
    ...
    func selectSinglePic(){
        let actionSheet = QSAlertController(title: nil, message: nil, preferredStyle: .actionSheet)
        actionSheet.titleColor = kAppTitleColor
        actionSheet.separatorColor = kSeparatorColor
