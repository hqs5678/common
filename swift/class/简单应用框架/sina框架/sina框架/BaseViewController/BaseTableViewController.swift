...
class BaseTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell:BaseCell = tableView.dequeueReusableCellWithIdentifier("vcCell", forIndexPath: indexPath) as! BaseCell
        let cellObj:BaseCellModel = data.objectAtIndex(indexPath.section).objectAtIndex(indexPath.row) as! BaseCellModel
        cell.setObj(cellObj)
        return cell
    }
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let cellObj = data.objectAtIndex(indexPath.section).objectAtIndex(indexPath.row) as! BaseCellModel
        cellObj.clickAction()
    }
