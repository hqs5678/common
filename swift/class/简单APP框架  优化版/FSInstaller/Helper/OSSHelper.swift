...
//     * 上传文件
//     */
//    func uploadFile(_ objectKey: String, uploadingData: Data, uploadProgress: ((_ bytesSent: Int64, _ totalByteSent: Int64, _ totalBytesExpectedToSend:Int64, _ progress: CGFloat) -> ()), completion: ((_ task: OSSTask) -> Void)) -> OSSTask{
//        
...
//     * 上传文件
//     */
//    func uploadFile(_ objectKey: String, uploadingData: Data, uploadProgress: ((_ bytesSent: Int64, _ totalByteSent: Int64, _ totalBytesExpectedToSend:Int64, _ progress: CGFloat) -> ()), completion: ((_ task: OSSTask) -> Void), waitUntilFinished: Bool) -> OSSTask{
//        
...
//     * 下载文件
//     */
//    func downloadFile(_ objectKey: String, downloadProgress: ((_ bytesWritten: Int64, _ totalBytesWritten: Int64, _ totalBytesExpectedToWrite:Int64, _ progress: CGFloat) -> ()), completion: ((_ task: OSSTask) -> Void)) -> OSSTask{
//        
...
//     * 下载文件
//     */
//    func downloadFile(_ objectKey: String, downloadProgress: ((_ bytesWritten: Int64, _ totalBytesWritten: Int64, _ totalBytesExpectedToWrite:Int64, _ progress: CGFloat) -> ()), completion: ((_ task: OSSTask) -> Void), waitUntilFinished: Bool) -> OSSTask{
//        
